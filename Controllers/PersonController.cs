...
namespace AzureSQL.Controllers
{
    public class PersonController : Controller
    {
        ...
        public PersonController(AzureDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Persons != null ? 
                          ...
                          Problem("Entity set 'AzureDBContext.Persons'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AzureDBContext.Persons'  is null.");
            }
            var person = await _context.Persons.FindAsync(id);
            if (person != null)
            {
